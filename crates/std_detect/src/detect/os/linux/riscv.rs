...
pub(crate) fn detect_features() -> cache::Initializer {
    ...
    'hwprobe: {
        ...
        // 20240411) and we chose to imply "Zicsr" (not "Zicntr" and "Zifence")
        ...
        // and "fence.i" ("Zifencei") is stated not directly executable from the
        // user mode on Linux (although no traps will be generated, the effect
        // of executing the instruction is unreliable unless SMP is disabled).
