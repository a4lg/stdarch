...
pub(crate) fn detect_features() -> cache::Initializer {
    ...
    'hwprobe: {
        ...
        // "Zicsr" and "Zicntr" (but not "Zifence") because "fence.i" is stated
        // not directly executable from the user mode on Linux (although no
        // traps will be generated, the effect of executing the instruction is
        // unreliable unless SMP is disabled).
    ...
    // if `riscv_hwprobe` is not available.
    if !is_v_set {
